...
public final class ListTests {
  ...
  @Test
  public void iteratorRemoveFront() {
    List<Integer> list = uutFromArgs(32, 54, 12, 66, -10);
    Iterator<Integer> it = list.iterator();
    it.next(); // hasNext has to be true
    it.remove();
    assertEquals(refFromArgs(54, 12, 66, -10), list);
  }
  ...
  public void iteratorRemoveMiddle() {
    ...
    it.next();
    it.next();
    it.next(); // hasNext has to be true for all these
    it.remove();
    assertEquals(refFromArgs(32, 54, 66, -10), list);
  }
  ...
  public void iteratorRemoveLast() {
    ...
    while (it.hasNext())
      it.next();
    it.remove();
    assertEquals(refFromArgs(32, 54, 12, 66), list);
  }
